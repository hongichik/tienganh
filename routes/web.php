...
use App\Http\Controllers\User\PartThreeController;
use App\Http\Controllers\User\PartFourController;
...
Route::middleware('auth')->group(function (): void {
	...
	Route::get('/writing/part-3', [PartThreeController::class, 'show'])->name('user.writing.part3');
	Route::post('/writing/part-3/answer', [PartThreeController::class, 'submitAnswer'])->name('user.writing.part3.answer');
	Route::post('/writing/part-3/personal-hint', [PartThreeController::class, 'savePersonalHint'])->name('user.writing.part3.personal-hint');
	Route::post('/writing/part-3/restart', [PartThreeController::class, 'restart'])->name('user.writing.part3.restart');
	Route::get('/writing/part-4', [PartFourController::class, 'show'])->name('user.writing.part4');
	Route::post('/writing/part-4/answer', [PartFourController::class, 'submitAnswer'])->name('user.writing.part4.answer');
	Route::post('/writing/part-4/restart', [PartFourController::class, 'restart'])->name('user.writing.part4.restart');
